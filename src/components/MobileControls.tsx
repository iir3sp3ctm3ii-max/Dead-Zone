...
// Rilevamento sicuro per evitare errori se 'navigator' non è subito disponibile
  ...
  return (
    <div
      style={{
        ...
        pointerEvents: "none", // Il contenitore non blocca nulla
        zIndex: 50,
        userSelect: "none",
        WebkitUserSelect: "none",
      }}
      // RIMOSSO onTouchStart da qui per evitare conflitti sulla sinistra
    >
      {/* ── JOYSTICK SINISTRO ─────────────────────────── */}
      <div
        ref={joystickRef}
      ...
      <div 
        ...
        style={{
          ...
          pointerEvents: "auto", // AGGIUNTO per intercettare il tocco!
          touchAction: "none",
      }} />
    </div>
  );
